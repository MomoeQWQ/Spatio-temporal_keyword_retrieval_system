...
def default_config() -> Dict:
    return {
        "web_host": "127.0.0.1",
        "web_port": 5099,
        "aui_path": os.path.join(PROJ_ROOT, "apps", "cli", "aui.pkl"),
        "keys_path": os.path.join(PROJ_ROOT, "apps", "cli", "K.pkl"),
        "config_path": os.path.join(PROJ_ROOT, "conFig.ini"),
        "dataset_path": os.path.join(PROJ_ROOT, "us-colleges-and-universities.csv"),
        "user_db_path": os.path.join(PROJ_ROOT, "apps", "cli", "users_db.json"),
