...
from online_demo.csp_server import Handler, CSPState
from online_demo.user_management import ensure_user_db
...
class ServerApp:
    def __init__(self) -> None:
        ...
        default_user_db = os.path.join(PROJ_ROOT, "online_demo", "users_db.json")
